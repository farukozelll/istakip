				...
				<div class="card-header py-3">
					...
					<div class="card-body">
						<form action="islemler/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate>
							...
							<button style="width: fit-content;" type="submit" name="projeduzenle" class="btn btn-success">Kaydet</button>
						</form>
					</div>
				</div>
			</div>
...
<?php include 'footer.php' ?><script src="ckeditor/ckeditor.js"></script>
	<script>
